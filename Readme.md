...
4. Трекинг и регистрация в MLflow.
5. CI/CD (Github/Gitlab) (обязательно линтер, тесты, сборка, деплой при MR в main).
6. Сервис на FastAPI с OpenAPI с упаковкой в docker-образ. Docker compose вам нужен будет только для отладки, в конечном счёте все будет будет в Kubernetes или Minikube.
...
9. Добавить веб UI, что точно должно быть: страница инференса, таблица последних предсказаний, флаги аномалий, кнопка «запустить переобучение», страница экспериментов, уведомления о дрейфе.
10. CD с помощью Ardo CD в Kubernetes или Minikube.
